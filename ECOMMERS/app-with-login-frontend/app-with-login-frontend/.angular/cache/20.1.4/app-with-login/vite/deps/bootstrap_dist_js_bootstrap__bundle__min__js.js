    ...
    !function(t, e) {
      ...
      class Ki extends W {
        ...
        _getPopperConfig() {
          ...
          return (this._inNavbar || "static" === this._config.display) && (F.setDataAttribute(this._menu, "popper", "static"), t2.modifiers = [{ name: "applyStyles", enabled: false }]), __spreadValues(__spreadValues({}, t2), g(this._config.popperConfig, [void 0, t2]));
        }
      ...
      class fs extends W {
        ...
        _getTemplateFactory(t2) {
          return this._templateFactory ? this._templateFactory.changeContent(t2) : this._templateFactory = new ts(__spreadProps(__spreadValues({}, this._config), { content: t2, extraClass: this._resolvePossibleFunction(this._config.customClass) })), this._templateFactory;
        }
      ...
      m(fs);
      const ps = ".popover-header", ms = ".popover-body", gs = __spreadProps(__spreadValues({}, fs.Default), { content: "", offset: [0, 8], placement: "right", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>', trigger: "click" }), _s = __spreadProps(__spreadValues({}, fs.DefaultType), { content: "(null|string|element|function)" });
      class bs extends fs {
        static get Default() {
          return gs;
        }
